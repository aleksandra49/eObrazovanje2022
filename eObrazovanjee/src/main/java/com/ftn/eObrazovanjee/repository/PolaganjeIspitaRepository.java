...
public interface PolaganjeIspitaRepository extends JpaRepository<PolaganjeIspita, Long>  {
	...
	@Query(value = "select p.naziv, pi.broj_bodova, pi.ispit_id, pi.student_id from polaganje_ispita as pi\r\n"
			...
			+ "where pi.broj_bodova  > 50 and pi.student_id  = :idStudent" , nativeQuery = true)
